...
insert into public.event_milestones (user_id, code, name, event_date, notes) values
    ('00000000-0000-0000-0000-000000000001', 'bogota_21k_2026', 'vChallenges 21K', '2026-12-26', 'https://www.vchallenges.co/2026/challenge/details/vchallenges21k'),
...
insert into public.macrocycle_phases (user_id, code, name, start_date, end_date, focus, sport, hr_cap, max_duration_min) values
    ...
    ('00000000-0000-0000-0000-000000000001', 'R7', 'Especifico 70.3', '2027-10-01', '2027-11-28', 'Brick + volumen tri', 'tri', 155, 180);
